...
/**
* word_len - locates the index marking the
* end of the first word contained within a
* string
...
/**
* strtow -split a string into worss
* @str: the string to be split
* Return: if str = NULL, str = "", or the function
* fails - NULL. otherwise - a pointer to an array
* of strings (words)
*/
